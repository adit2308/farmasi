...
$c=mysql_query("select masuk from barang_masuk where id='$id'");
$d=mysql_fetch_array($c);
$kembalikan_d=$d['masuk'];
...
$akhir=$data['akhir']-$d['masuk']-$data['keluar'];
$masuk=$data['masuk']-$d['masuk'];
...
mysql_query("update barang set masuk='$masuk',akhir='$akhir' where nama='$nama'");
mysql_query("delete from barang_masuk where id='$id'");
// echo "update barang set masuk='$masuk',akhir='$akhir' where nama='$nama'";die;

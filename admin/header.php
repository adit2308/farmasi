...
<head>
	...
	include 'config.php';
	?>
	<title>STOK BARANG FARMASI</title>
...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="" class="navbar-brand">STOK BARANG FARMASI</a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<?php 
					$periksa=mysql_query("select * from barang where awal <=0");
					while($q=mysql_fetch_array($periksa)){	
						if($q['awal']<=0){			
							echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama']."</a> yang tersisa tinggal <a style='color:red'>". $q['awal']."</a> . silahkan pesan lagi !!</div>";	
						}
					}
					?>
				</div>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="barang_masuk.php"><span class="glyphicon glyphicon-briefcase"></span>  Barang Masuk</a></li>
			<li><a href="barang_keluar.php"><span class="glyphicon glyphicon-briefcase"></span>  Barang Keluar</a></li>        												

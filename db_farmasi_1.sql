/*
 ...
 Source Schema         : db_farmasi

 Target Server Type    : MySQL
 Target Server Version : 50508
 File Encoding         : 65001

 Date: 07/04/2021 10:50:39
*/
...
CREATE TABLE `barang`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `jenis` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `kecil` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `besar` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 321 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
INSERT INTO `barang` VALUES (3, 'BHP', 'ALKOHOL SWAB', 'ALKOHOL swab ONEMED JKN', 0, '0.7', '100 BUAH', '1 BOX', 232, 0, 0, 232, '2023-11-01', '0000-00-00', '0');
...
INSERT INTO `barang` VALUES (16, 'BHP', 'MASKER N 95', 'MASKER N 95', 0, '', '20 BUAH', '1 BOX', 0, 10, 0, 10, '0000-00-00', '0000-00-00', '0');
...
INSERT INTO `barang` VALUES (68, 'BHP COVID-19 (HIBAH)', 'MASKER N 95 ', 'MASKER N 95', 0, '', '1 BUAH', '', 0, 10, 0, 10, '0000-00-00', '0000-00-00', '0');
...
INSERT INTO `barang` VALUES (280, 'KLINIK RUTIN LAINNYA', 'NARKOBA THC-C', 'NARKOBA THC-C', 0, '100 ml', '1 BOTOL', '', 0, 0, 0, 0, '0000-00-00', '0000-00-00', '0');
...
CREATE TABLE `barang_asli`  (
  ...
  `jenis` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `suplier` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `barang_masuk` VALUES (1, '2021-04-06', 'MASKER N 95', 10);
...
CREATE TABLE `jenis_barang`  (
  ...
  `jenis_barang` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `pengeluaran`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tanggal` date NOT NULL,
  `keperluan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `nama` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `jumlah` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
